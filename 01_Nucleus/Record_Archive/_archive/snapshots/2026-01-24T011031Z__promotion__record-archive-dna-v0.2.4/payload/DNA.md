...
7. **DNA 승격/변경의 플래그십 합의 (v0.2.4)**
   ...
   - 근거: `04_Agentic_AI_OS/METADoctrine.md`의 Upper-Institution Change Gate 및 `02_AAOS-Immune_system/AAOS_DNA_DOCTRINE_RULE.md`의 Multi-Agent Consensus Doctrine과 정렬.
...
- `04_Agentic_AI_OS/01_AAOS-Record_Archive/DNA_BLUEPRINT.md`의 버전/정책/Hard Rules 변경
...
2. **Deliberation Packet**
   - `01_AAOS-Record_Archive/templates/DELIBERATION_PACKET_TEMPLATE.md` 형식을 사용
...
4. **Immune System 판정/감사**
   - Inquisitor 심판 결과를 `02_AAOS-Immune_system/AUDIT_LOG.md`에 남기고, 상위기관 변경이라면 `META_AUDIT_LOG.md`에도 참조를 남긴다
