...
1. Manifest 정합성
   - `record_path`가 pending manifest 경로와 일치 (`01_Nucleus/Record_Archive/pending/ISSUE-NUC-20260214-0001-WORKFLOW_MANIFEST.md`)
...
- 종료 후 결과를 `01_Nucleus/Record_Archive/pending/`의 Stage-6 연계 비평 문서로 이관
