...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python audit.py verify <audit_log.md>  - Verify integrity")
        print("  python audit.py stats <audit_log.md>   - Show statistics")
        sys.exit(1)

    command = sys.argv[1]
    audit_path = Path(sys.argv[2]) if len(sys.argv) > 2 else Path("AUDIT_LOG.md")
