...
def default_audit_path() -> Path:
    # .../01_Nucleus/Immune_system/SWARM_INQUISITOR_SKILL/blueprint-judgment/scripts/verify_blueprint.py
...
def main() -> int:
    ...
    parser.add_argument("--audit", default=None, help="Audit log path (default: 01_Nucleus/Immune_system/AUDIT_LOG.md)")
