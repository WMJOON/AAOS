...
```bash
python3 04_Agentic_AI_OS/01_Nucleus/Immune_system/SWARM_INQUISITOR_SKILL/_shared/auto_inquisitor.py --context "<path>" --severity high --format md
```

Text 출력:

```bash
python3 04_Agentic_AI_OS/01_Nucleus/Immune_system/SWARM_INQUISITOR_SKILL/_shared/auto_inquisitor.py --context "<path>" --severity medium --format text
```
