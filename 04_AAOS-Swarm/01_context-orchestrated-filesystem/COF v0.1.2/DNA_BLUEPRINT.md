...
name: "AAOS-COF"
version: "0.1.2"
scope: "04_Agentic_AI_OS/04_AAOS-Swarm/01_context-orchestrated-filesystem/COF v0.1.2"
owner: "AAOS Swarm"
created: "2026-01-21"
status: canonical
...
natural_dissolution:
  ...
  termination_conditions:
    ...
    - "해당 COF 버전(v0.1.2)이 상위 버전으로 승계되어 더 이상 사용되지 않을 때"
  dissolution_steps:
...
- Skills: `skills/` (예: task-manager node 생성/티켓 발행)
