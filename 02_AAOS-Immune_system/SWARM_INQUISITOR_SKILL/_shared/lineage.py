...
def resolve_lineage(
    ...
    *,
    ...
    record_archive_root = aaos_root / "01_AAOS-Record_Archive"
    immune_root = aaos_root / "02_AAOS-Immune_system"
    deliberation_root = aaos_root / "03_AAOS-Deliberation_Chamber"
