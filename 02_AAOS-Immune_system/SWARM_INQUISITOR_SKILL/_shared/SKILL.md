...
2. 이식 시에는 최소 단위로 아래를 함께 복사한다.
   - `02_AAOS-Immune_system/SWARM_INQUISITOR_SKILL/blueprint-judgment/`
   - `02_AAOS-Immune_system/SWARM_INQUISITOR_SKILL/permission-judgment/`
   - `02_AAOS-Immune_system/SWARM_INQUISITOR_SKILL/_shared/` (본 폴더)
