---
context_id: cof-ticket-solving-spec
role: REFERENCE
state: const
scope: swarm
lifetime: persistent
created: "2026-01-31"
version: "1.2"
parent_skill: cof-ticket-solving
---
...
본 문서는 `cof-ticket-solving` 스킬의 상세 설계 스펙을 정의한다.
...
### 6.3 cof-task-context-management
...
- 티켓 생성 (cof-task-context-management 역할)
- 에이전트 학습/튜닝
...
|----------|-------------------|-------------|
| Parent Skill | `@ref(cof-ticket-solving)` | 스킬 메인 문서 |
| cof-glob-indexing | `@ref(cof-glob-indexing)` | 컨텍스트 인덱싱 |
| cof-task-context-management | `@ref(cof-task-context-management)` | 티켓 관리 |
