...
- Governance: `../00.pointerical-tooling/references/cof-environment-set.md`
- Parent Skill: `00.pointerical-tooling`
- Neighbor Skills: `cof-glob-indexing`, `cof-task-context-management`, `cof-ticket-solving`
